...
- [Figmaの苦境：Claude Designの登場とSaaSエコノミクスの地殻変動](/journals/2026-04-25/055/)
- [Claude Designをめぐる考察：デザインの「真実の源」は再びコードへと回帰する](/journals/2026-04-25/110/)
- [Google Labs、AI向けデザインシステム定義フォーマット「DESIGN.md」をオープンソース化](/journals/2026-04-25/015/)
- [AIエージェント時代のプロダクト作りの基礎知識「Agentic UX」とは？](/journals/2026-04-25/044/)
...
- [Zero-dayの終焉：Mozilla、AI（Claude Mythos）を活用してFirefoxの脆弱性271件を一挙修正](/journals/2026-04-25/017/)
- [Anthropic「Claude Mythos」のセキュリティ能力に関する批判的検証：誇大広告と信頼の崩壊](/journals/2026-04-25/151/)
- [ペンタゴンが排除したAnthropicの最強AI「Mythos」、NSAが極秘利用か](/journals/2026-04-25/143/)
- [GPT-5.5によるハッキング能力の飛躍的向上：XBOWによる脆弱性診断ベンチマーク評価](/journals/2026-04-25/182/)
...
- [OpenAI、GPT-5.5を発表 — Terminal-Bench 2.0で82.7%、エージェントコーディングと長期タスクで実用的飛躍](/journals/2026-04-25/075/)
- [OpenAI Codexの新機能「Chronicle」：画面内容から作業コンテキストを自動記憶](/journals/2026-04-25/028/)
- [OpenAI、Codex駆動の「Workspace Agents」をChatGPT Business/Enterprise/Edu/Teachers向けに研究プレビュー公開](/journals/2026-04-25/077/)
...
- [AmazonとAnthropicが戦略的提携を大幅拡大：1000億ドルのAWS利用コミットと最大250億ドルの追加出資](/journals/2026-04-25/139/)
- [Amazon Bedrock AgentCoreの新機能発表：インフラ構築を不要にし、数分でエージェントを稼働可能に](/journals/2026-04-25/006/)
- [Claude Cowork in Amazon Bedrock の提供開始：組織全体での AI 活用を AWS 環境内で実現](/journals/2026-04-25/005/)
...
- [Anthropicが$20のProプランから「Claude Code」を一時削除、AI課金モデルの限界が露呈か](/journals/2026-04-25/181/)
- [GitHub Copilot個人向けプランの変更：新規登録の停止と利用制限の強化](/journals/2026-04-25/038/)
- [Anthropic、Claude ProプランからClaude Codeを削除するA/Bテストを実施。開発者コミュニティでは不信感と競合への乗り換え議論が加速](/journals/2026-04-25/062/)
...
- [LLM-as-a-Verifier：スコア粒度・反復検証・基準分解の3軸スケーリングでTerminal-Bench 2およびSWE-Bench VerifiedでSOTA達成](/journals/2026-04-25/052/)
- [Qwen3.6-27B：27Bデンスモデルがフラッグシップ級コーディング性能を達成、15倍規模のQwen3.5-397B-A17Bを全主要ベンチで凌駕](/journals/2026-04-25/108/)
- [Kimi K2.6発表：コーディングと長時間自律実行を強化したオープンソースAIモデル](/journals/2026-04-25/164/)
...
- [CLAUDE.md の肥大化を 3 層構造で 83% 軽くした — 実測と試行錯誤の記録](/journals/2026-04-25/200/)
- [Android CLIと「Skills」の導入：AIエージェントによる開発を3倍高速化](/journals/2026-04-25/003/)
- [ハーネスエンジニアリング時代の「環境構築」を一撃で終わらせるAPM](/journals/2026-04-25/105/)
- [プロンプトの再現性をAIに自動チューニングさせる方法 — 暗黙知を排除する](/journals/2026-04-25/197/)
