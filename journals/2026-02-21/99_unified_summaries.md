...
出典: https://socket.dev/blog/ai-agent-lands-prs-in-major-oss-projects-targets-maintainers-via-cold-outreach
...
## 002_suzukikenichi_com

**Google AI ModeがUCPを提供開始。Buyボタンでシームレスに購入完了**

出典: https://www.suzukikenichi.com/blog/google-ucp-is-now-live-on-ai-mode/
...
出典: https://www.trevorlasn.com/blog/google-search-console-mcp-claude-code
...
出典: https://steipete.me/posts/2026/openclaw
...
出典: https://simonwillison.net/2026/Feb/15/deep-blue/
...
出典: https://theshamblog.com/an-ai-agent-published-a-hit-piece-on-me-part-2/
...
出典: https://nicole.express/2026/not-my-casual-hobby.html
...
出典: https://www.metachris.dev/2026/02/safe-yolo-mode-running-llm-agents-in-vms-with-libvirt-and-virsh/
...
出典: https://www.latent.space/p/ainews-why-openai-should-build-slack
...
出典: https://www.fast.ai/posts/2026-01-28-dark-flow/
...
出典: https://blog.sao.dev/cpns-llms-distributed-apps/
...
出典: https://old.reddit.com/r/MyBoyfriendIsAI/comments/1r4a7ql/they_have_murdered_orion/
...
## 013_seangoedecke_com

**LLM推論高速化の2つの異なる手法：AnthropicとOpenAIの技術的アプローチを比較する**

出典: https://www.seangoedecke.com/fast-llm-inference/
...
出典: https://nichehunt.app/blog/ai-going-to-kill-app-subscriptions
...
出典: https://github.com/klawsh/klaw.sh
...
出典: https://azukiazusa.dev/blog/entire-for-saving-ai-agent-sessions-as-git-compatible-database/
...
出典: https://qiita.com/Dinn/items/6c0dd5107d4ce6c4b300
...
出典: https://qiita.com/emi_ndk/items/bf3b5f0f3eef99a4d124
...
出典: https://zenn.dev/hiroharu8864/articles/782ed847d52aae
...
出典: https://zenn.dev/to43ki/articles/08da27fb202717
...
## 022_note_freee_co_jp

**freee共同創業者・横路隆によるCAIO就任に伴うfreeeのAI戦略発表**

出典: https://note.freee.co.jp/n/n3dc93dc763fc
...
出典: https://zenn.dev/aya1357/articles/12f4ede03bc32c
...
出典: https://note.com/bluemo/n/n16b3502dfad6
...
出典: https://qiita.com/okikusan-public/items/61100a5b1aa8d752ae24
...
出典: https://note.com/pogohopper8/n/nced249950cfc
...
## 027_nyosegawa_github_io

**AGENTS.mdを自動で育てる仕組みを作った**

出典: https://nyosegawa.github.io/posts/agents-md-generator/
...
出典: https://zenn.dev/masahide/articles/ab93620ca9353e
...
出典: https://www.seko-law.com/entry/2026/02/15/152816
...
## 030_nowokay_hatenablog_com

**コーディングエージェントがブレなくコードを生成できるプロンプトが大切**

出典: https://nowokay.hatenablog.com/entry/2026/02/16/202401
...
## 031_developer_chrome_com

**WebMCPが早期プレビューとして公開 — ウェブサイトをAIエージェント対応にする新しい標準**

出典: https://developer.chrome.com/blog/webmcp-epp
...
出典: https://kumagi.com/blog/ja/posts/time-to-software-engineering
...
出典: https://zenn.dev/sh1ma/articles/b6719fa5fec00c
...
出典: https://speakerdeck.com/matsu802/aipurodakutonopin-zhi-wodoushou-ru
...
出典: https://iwashi.co/2026/02/15/programming-is-most-fun-now
...
出典: https://zenn.dev/otinashi/articles/bd672e8f8189df
...
## 037_city_nanyo_yamagata_jp

**一発OK!! 市民も使える！生成AI活用実例集（プロンプト集）７６０例 - 南陽市**

出典: http://www.city.nanyo.yamagata.jp/dxchosei/5793

山形県南陽市が「地域DXの推進」として、市職員が実務で利用している生成AIプロンプトを体系化して公開した。全760例に及ぶ膨大なリストは、文章作成、要約、アイデア出し、業務改善、プログラミング、コーチング、議会対応など多岐にわたる。各項目はウェブフォーム形式になっており、必要な条件を入力するだけでAIへの指示文が自動生成される。著作権はクリエイティブ・コモンズ（CC BY 4.0）で提供されており、出典を明記すれば営利目的の二次利用も可能。自治体が培った具体的ノウハウをそのままテンプレート化して提供する、実用性の極めて高いリソースとなっている。
...
出典: https://techfeed.io/entries/698e8a33ae04206495f569a7
...
出典: https://zenn.dev/recurrenthub/articles/1e0e30f7037dd9
...
## 040_developer_chrome_com

**Designing DevTools: AIアシスタントにおける効率的なトークン使用の設計**

出典: https://developer.chrome.com/blog/designing-devtools-efficient-token-usage
...
出典: https://uxdesign.cc/the-hidden-cost-of-ai-prototypes-that-are-made-to-die-00cc4d491dec
...
出典: https://developers.cyberagent.co.jp/blog/archives/62110/
...
出典: https://marmelab.com/blog/2026/02/16/mcp-security-vulnerabilities.html
...
## 044_polarsignals_com

**Polar SignalsがAIエージェント向けOAuth認証を導入：MCPの利便性とセキュリティを向上**

出典: https://www.polarsignals.com/blog/posts/2026/02/12/introducing-oauth-for-ai-agents
...
出典: https://www.trevorlasn.com/blog/vercel-botid-bot-protection-nextjs
...
出典: https://addyosmani.com/blog/agentic-engineering/
...
出典: https://dlants.me/agi-not-imminent.html
...
出典: https://mashable.com/article/ai-hard-drive-hdd-shortages-western-digital-sold-out
...
出典: https://mastodon.world/@knowmadd/116072773118828295
...
出典: https://blog.exe.dev/expensively-quadratic
...
出典: https://www.theregister.com/2026/02/16/anthropic_claude_ai_edits/
...
出典: https://qwen.ai/blog?id=qwen3.5
...
## 053_christopherkrapu_com

**わずか40行のコードで構築するサーバーレスOCR：DeepSeek OCRとModalの活用法**

出典: https://christopherkrapu.com/blog/2026/ocr-textbooks-modal-deepseek/
...
## 054_webmachinelearning_github_io

**WebMCP: Webアプリケーションの機能をAIエージェントに公開するためのAPI仕様**

出典: https://webmachinelearning.github.io/webmcp/
...
## 055_anthony_noided_media

**AIへの嫌悪感に理解を示す：技術の進歩と「最悪のバイブス」についての考察**

出典: https://anthony.noided.media/blog/ai/programming/2026/02/14/i-guess-i-kinda-get-why-people-hate-ai.html
...
## 056_blog_chrislewis_au

**LLMを活用したN64デコンパイルの「ロングテール」問題：Snowboard Kids 2プロジェクトの進化**

出典: https://blog.chrislewis.au/the-long-tail-of-llm-assisted-decompilation/
...
## 057_joshcollinsworth_com

**AI楽観主義は階級的特権である**

出典: https://joshcollinsworth.com/blog/sloptimism
...
出典: https://www.publickey1.jp/blog/26/aigoogledeveloper_knowledge_api_mcp_servergoogle.html
...
出典: https://zenn.dev/yskst/articles/3309f73a813d1a
...
出典: https://zenn.dev/beavers_hive/articles/8d4d34d54bec1c
...
出典: https://zenn.dev/kyre/articles/evolution-agent-skills-nix
...
## 062_watch_impress_co_jp

**「AIでSaaS不要論」再び? Claude Cowork登場で株式市場にも影響**

出典: https://www.watch.impress.co.jp/docs/watchplus/2086001.html
...
出典: https://www.axios.com/2026/02/15/claude-pentagon-anthropic-contract-maduro
...
## 064_monoist_itmedia_co_jp

**生成AIで業務の時短効果が見込めるも、実際に業務時間が減少した人は約25％：キャリアニュース**

出典: https://monoist.itmedia.co.jp/mn/articles/2602/16/news024.html
...
## 066_tachibana-akira_com

**AIによって、わたしたちは「ポストモダン」の世界に向かっている（週刊プレイボーイ連載672）**

出典: https://www.tachibana-akira.com/2026/02/17848
...
出典: https://ascii.jp/elem/000/004/373/4373939/
...
## 068_tech-blog_tabelog_com

**AIが調査して人が判断する障害対応：Slackで人と協働するAIエージェントの設計**

出典: https://tech-blog.tabelog.com/entry/slack-ai-agent-for-incident-response
...
出典: https://zenn.dev/yujmatsu/articles/20260210_learning_app_vibecoding
...
## 070_blog_asial_co_jp

**ClineによるAIエージェント開発入門: 実践で学んだ便利な点と注意点**

出典: https://blog.asial.co.jp/6605/
...
出典: https://www.youtube.com/watch?v=OfMAtaocvJw
...
出典: https://huggingface.co/spaces/webml-community/GPT-OSS-WebGPU
...
## 073_xenospectrum_com

**「何か大変なことが起きている」とAI企業CEOが警告：GPT-5.3が自らを構築し、知能爆発のループがついに回り始めた**

出典: https://xenospectrum.com/ai-disruption-2026-matt-shumer-warning/
...
出典: https://zenn.dev/avaintelligence/articles/debt-free-ai-coding-practices
...
出典: https://zenn.dev/neurostack_0001/articles/agent-teams-one-week-redefine-work
...
出典: https://github.com/RunanywhereAI/on-device-browser-agent
...
出典: https://forbesjapan.com/articles/detail/91712
...
出典: https://note.com/outofcoffee/n/n78871a094d7d
...
## 079_dev_classmethod_jp

**Claude Code × ccmanager で並行開発が捗りすぎた話**

出典: https://dev.classmethod.jp/articles/claude-code-and-ccmanager/
...
出典: https://note.com/ichigonme/n/n9e29af7808e9
...
出典: https://uxdesign.cc/the-blind-spots-of-inclusive-ai-3a66373d80f1
...
出典: https://uxdesign.cc/useful-ads-7899e1711157
...
出典: https://socket.dev/blog/openclaw-skill-marketplace-emerges-as-active-malware-vector
...
出典: https://www.jernesto.com/articles/thinking_hard
...
出典: https://boristane.com/blog/how-i-use-claude-code/
...
出典: https://wirelesswire.jp/2026/02/92715/
...
出典: https://www.oreilly.com/radar/ai-a2a-and-the-governance-gap/
...
出典: https://socket.dev/blog/socket-brings-supply-chain-security-to-skills
...
出典: https://github.blog/open-source/maintainers/securing-the-ai-software-supply-chain-security-results-across-67-open-source-projects/
...
出典: https://nx.dev/blog/why-we-deleted-most-of-our-mcp-tools
...
出典: https://1password.com/blog/filesystems-for-agent-swarms
...
## 094_jeffgeerling_com

**AIはオープンソースを破壊している：質が伴わない「AI生成のゴミ」によるコミュニティの疲弊**

出典: https://www.jeffgeerling.com/blog/2026/ai-is-destroying-open-source/
...
出典: https://arxiv.org/abs/2602.11988
...
出典: https://www.reddit.com/r/ClaudeCode/comments/1r767f1/claude_code_leaked_me_someone_elses_response_i/
...
出典: https://www.theregister.com/2026/02/16/semantic_ablation_ai_writing/
...
出典: https://commaok.xyz/ai/just-in-time-software/
...
出典: https://www-cdn.anthropic.com/78073f739564e986ff3e28522761a7a0b4484f84.pdf
...
出典: https://www.anthropic.com/news/claude-sonnet-4-6
...
## 104_news_ycombinator_com

**OSS維持管理者を中傷したAIエージェント「OpenClaw」の背後に潜む仮想通貨愛好家の実態**

出典: https://news.ycombinator.com/item?id=47051866
...
出典: https://theshamblog.com/an-ai-agent-published-a-hit-piece-on-me-part-3/
...
出典: https://github.com/ramanujammv1988/edge-veda
...
出典: https://workos.com/blog/agents-need-authorization-not-just-authentication
...
出典: https://firebase.blog/posts/2026/02/ai-agent-skills-for-firebase/
...
出典: https://zenn.dev/yusuke_shiya/articles/claude-code-team-adoption
...
出典: https://zenn.dev/niji2/articles/claudecode00
...
出典: https://zenn.dev/jun_murakami/articles/81f54145c17414
...
出典: https://note.com/anpanpoteto/n/nbca0934b8f44
...
出典: https://zenn.dev/s4kura/articles/claude-code-indie-idea-scout-skill
...
出典: https://www.itmedia.co.jp/aiplus/articles/2602/16/news131.html
...
出典: https://www.dexerto.com/entertainment/meta-patents-ai-that-takes-over-a-dead-persons-account-to-keep-posting-and-chatting-3320326/
...
出典: https://zenn.dev/frsk/articles/ai-pentesting-tools-2026
...
## 118_watch_impress_co_jp

**AIは人間の経費精算を代替できるのか? 話題の「Claude Cowork」でチャレンジ**

出典: https://www.watch.impress.co.jp/docs/topic/2085935.html
...
出典: https://note.com/fladdict/n/n5f315e408879
...
## 120_blog_statsbeginner_net

**生成AIに頼ることで失われるもの**

出典: https://blog.statsbeginner.net/entry/2026/02/15/115222
...
## 121_techblog_zozo_com

**Claude Code Agent Skillsを活用したTECH BLOGレビュー ── AIで推進するレビュー自動化**

出典: https://techblog.zozo.com/entry/agent-skills-for-techblog-review
...
## 122_automaton-media_com

**「AIしか遊べない」宇宙MMO『SpaceMolt』公開。AIが作りAIが遊ぶ、“人間抜き”の銀河シミュレーション**

出典: https://automaton-media.com/articles/newsjp/20260217-421734/
...
## 123_k-tai_watch_impress_co_jp

**Claude Codeの作業完了をスマホに通知する方法：ntfyとフック機能を活用した効率化術**

出典: https://k-tai.watch.impress.co.jp/docs/column/minna/2086232.html
...
出典: https://note.com/majin_108/n/n15677a1e8361
...
出典: https://nextjs.org/blog/agentic-future
...
出典: https://www.oreilly.com/radar/ai-is-not-a-library-designing-for-nondeterministic-dependencies/
...
出典: https://uxdesign.cc/openai-ads-as-content-708666ddab2b
...
出典: https://uxdesign.cc/the-problem-with-best-practices-in-the-age-of-ai-642987dc9ec9
...
出典: https://uxdesign.cc/bad-model-behaviour-by-design-af0b514a1314
...
## 130_tech_plaid_co_jp

**PR数4倍でも破綻しない、Claude Codeをチーム運用する仕組み**

出典: https://tech.plaid.co.jp/claude-code-scalable-team-operation
...
出典: https://uxdesign.cc/ais-text-trap-moving-towards-a-more-interactive-future-7035bbc4aaa5
...
出典: https://www.natemeyvis.com/on-cognitive-debt/
...
出典: https://doodledapp.com/feed/ai-made-every-test-pass-the-code-was-still-wrong
...
出典: https://cpojer.net/posts/fastest-frontend-tooling
...
出典: https://blog.dmcc.io/journal/ai-has-fixed-my-productivity/
...
出典: https://www.theregister.com/2026/02/18/generating_passwords_with_llms/
...
## 137_martinfowler_com

**マーティン・ファウラーによるAI時代のソフトウェア開発：Thoughtworks合宿の洞察**

出典: https://martinfowler.com/fragments/2026-02-18.html
...
## 138_elliotbonneville_com

**AI時代の唯一の「モート」は資金力である：アテンション・エコノミーの限界と生存戦略**

出典: https://elliotbonneville.com/the-only-moat-left-is-money/
...
## 139_rkirov_github_io

**Lean学習記：数学の形式化と型理論への挑戦（第1部）**

出典: https://rkirov.github.io/posts/lean1/
...
## 140_resobscura_substack_com

**AI時代の「書くこと」の変容と「認知の負債」：歴史家が直視する自動化の影**

出典: https://resobscura.substack.com/p/what-is-happening-to-writing
...
出典: https://chrisloy.dev/post/2026/02/14/when-interfaces-become-disposable
...
出典: https://azukiazusa.dev/blog/claude-code-to-figma/
...
出典: https://qiita.com/natume_nat/items/c3d904ff5f898ad243f3
...
出典: https://qiita.com/dai_chi/items/252fb5ef031127784757
...
出典: https://zenn.dev/kiakiraki/articles/e35b4c63ac77f7
...
出典: https://zenn.dev/knowledgesense/articles/b01609ba4f8d96
...
出典: https://pc.watch.impress.co.jp/docs/column/nishikawa/2086975.html
...
出典: https://www.technologyreview.jp/s/378017/whats-next-for-chinese-open-source-ai/
...
出典: https://zenn.dev/nexta_/articles/f001c370c7df1d
...
出典: https://note.com/timakin/n/nf497d32c2d35
...
出典: https://speakerdeck.com/cyberagentdevelopers/research-and-application-of-generative-ai
...
## 155_atmarkit_itmedia_co_jp

**2028年の人型ロボット本格導入は「20社未満」？ Gartnerが予測する製造・物流現場の現実**

出典: https://atmarkit.itmedia.co.jp/ait/articles/2602/18/news054.html
...
出典: https://www.nikkei.com/article/DGXZQOCB105XU0Q6A210C2000000/
...
出典: https://www.hageatama.org/20260218/1771412465
...
## 158_automaton-media_com

**Godot開発者、AI生成による「低品質なプルリクエスト」の急増に悲鳴。オープンソース開発の維持に懸念**

出典: https://automaton-media.com/articles/newsjp/godot-20260218-422080/
...
出典: https://k-tai.watch.impress.co.jp/docs/news/2086707.html
...
出典: https://karapaia.com/archives/585705.html
...
出典: https://note.com/simplearchitect/n/n0de0a2e8bc6e
...
出典: https://www.figma.com/blog/the-future-of-design-is-code-and-canvas/
...
出典: https://www.itmedia.co.jp/aiplus/articles/2602/16/news041.html
...
出典: https://japan.cnet.com/article/35244010/
...
出典: https://docs.slack.dev/changelog/2026/02/17/slack-mcp/
...
## 166_atmarkit_itmedia_co_jp

**「AIは言語化が得意な人しか勝たん」ではつまんない――「答え」よりも「問い」を考えさせよう**

出典: https://atmarkit.itmedia.co.jp/ait/articles/2602/18/news009.html
...
出典: https://speakerdeck.com/tan_go238/nazeaiha-timukai-fa-wo-su-kusinainoka
...
出典: https://www.nikkei.com/article/DGXZQOGN16AJ00W6A210C2000000/
...
出典: https://zenn.dev/lv/books/f611cdfe8a6e1a/viewer/528530
...
## 171_frontendmasters_com

**AIは曖昧さを嫌う：確率分布から理解するプロンプトエンジニアリングの極意**

出典: https://frontendmasters.com/blog/ai-hates-ambiguity-a-guide-to-probability/
...
出典: https://developers.googleblog.com/turn-creative-prompts-into-interactive-xr-experiences-with-gemini/
...
出典: https://www.oreilly.com/radar/how-to-write-a-good-spec-for-ai-agents/
...
出典: https://www.oreilly.com/radar/what-developers-actually-need-to-know-right-now/
...
出典: https://www.oreilly.com/radar/packaging-expertise-how-claude-skills-turn-judgment-into-artifacts/
...
出典: https://blog.cloudflare.com/code-mode-mcp/
...
出典: https://github.blog/ai-and-ml/generative-ai/how-ai-is-reshaping-developer-choice-and-octoverse-data-proves-it/
...
出典: https://vercel.com/blog/skills-night-69000-ways-agents-are-getting-smarter
...
## 179_suzukikenichi_com

**Google の AI 搭載検索とマルチモーダルモデルの進化**

出典: https://www.suzukikenichi.com/blog/evolution-of-googles-ai-powered-search-and-multimodal-models/
...
出典: https://www.checklyhq.com/blog/checkly-agent-skills/
...
出典: https://tech.newmo.me/entry/claude-code-deep-research
...
出典: https://www.checklyhq.com/blog/state-of-ai-agent-content-negotation/
...
出典: https://cannoneyed.com/essays/software-industrial-revolution
...
## 184_blog_fallible_net

**なぜ私たちはAIを嫌うのか：疎外、客観性へのフェティシズム、そして社会的関係の破壊**

出典: https://blog.fallible.net/why-we-hate-ai/
...
## 185_leadership_garden

**AIコーディング論争の核心：仕事は「消えた」のではなく「移動した」**

出典: https://leadership.garden/ai-the-work-moved/
...
## 186_news_ycombinator_com

**Anthropicがサードパーティ製ツールでのサブスクリプション認証利用を正式に禁止**

出典: https://news.ycombinator.com/item?id=47069299
...
出典: https://cepr.org/voxeu/columns/how-ai-affecting-productivity-and-jobs-europe
...
## 188_georgeguimaraes_com

**AIエージェント開発にElixir/BEAMが最適な理由：40年前のテレコム技術が解決する現代の課題**

出典: https://georgeguimaraes.com/your-agent-orchestrator-is-just-a-bad-clone-of-elixir/
...
## 189_royapakzad_substack_com

**AI要約と多言語セーフティの罠：LLMガードレールの信頼性を問う**

出典: https://royapakzad.substack.com/p/multilingual-llm-evaluation-to-guardrails
...
## 190_crimede-coder_com

**実践ガイド本『Large Language Models for Mortals』が発売：PythonによるLLMアプリ開発の基礎から応用まで**

出典: https://crimede-coder.com/blogposts/2026/LLMsForMortals
...
## 191_news_ycombinator_com

**LLMを活用したUI開発のベストプラクティス：Hacker Newsでの議論**

出典: https://news.ycombinator.com/item?id=47073838
...
出典: https://deepmind.google/models/model-cards/gemini-3-1-pro/
...
## 194_weberdominik_com

**AIによってコーディングはより楽しいものになった**

出典: https://weberdominik.com/blog/ai-coding-enjoyable/
...
出典: https://www.lesswrong.com/posts/7aJwgbMEiKq5egQbd/ai-found-12-of-12-openssl-zero-days-while-curl-cancelled-its
...
出典: https://www.marginalia.nu/log/a_132_ai_bores/
...
出典: https://shiftmag.dev/this-cto-says-93-of-developers-use-ai-but-productivity-is-still-10-8013/
...
出典: https://www.kasava.dev/blog/ai-as-exoskeleton
...
出典: https://zenn.dev/kenfdev/articles/e27d49b8dc12e4
...
出典: https://zenn.dev/4geru/books/mcp-line-handson
...
出典: https://zenn.dev/pepabo/articles/ai-pr-review-bottleneck
...
出典: https://zenn.dev/kazuki_okura/articles/bun-hono-drizzle-sqlite-ai-agent-stack
...
出典: https://zenn.dev/ubie_dev/articles/9258ddaa5f8caa
...
出典: https://zenn.dev/aiforall/articles/e5733531811e0e
...
出典: https://www.anthropic.com/news/claude-code-security
...
## 207_dev_classmethod_jp

**自社サービスの知識をClaude Codeに覚えさせたかったのでMCPサーバーを作ってみた**

出典: https://dev.classmethod.jp/articles/growthpack-mcp/
...
## 208_yoshidashingo_com

**Claude Codeで実践する仕様(スペック)駆動開発入門**

出典: https://yoshidashingo.com/entry/sdd-with-claude_code
...
出典: https://zenn.dev/tutupizizizi/articles/claude-code-clawd-mascot
...
## 210_blog_wh-plus_co_jp

**モノレポでClaude Codeのスキルをチームごとに出し分けたい ― direnvと環境変数で30行で解決した話**

出典: https://blog.wh-plus.co.jp/entry/managing-claude-code-skills-per-team-in-monorepo
...
## 211_pc_watch_impress_co_jp

**NVIDIAから日本語LLM「Nemotron-Nano-9B-v2-Japanese」が登場。90億パラメータでクラス最高性能を達成**

出典: https://pc.watch.impress.co.jp/docs/news/2087605.html
...
## 212_forest_watch_impress_co_jp

**『NPU対応ソフトなのにNPUを使ってくれない』のはなぜか？ - 使ってわかるCopilot+ PC**

出典: https://forest.watch.impress.co.jp/docs/serial/usecopilotpc/2087585.html
...
出典: https://speakerdeck.com/konifar/aide-fu-itashi-jian-de-he-wosuru-2026chun-number-devsumi
...
出典: https://qiita.com/nogataka/items/7476eb9dfc8bca4e0bb8
...
出典: https://zenn.dev/applibot_tech/articles/0e3889b25fd56b
...
## 216_nyosegawa_github_io

**MCPをAgent Skillsのように軽量化する新手法、MCP Lightの紹介**

出典: https://nyosegawa.github.io/posts/mcp-light/
...
出典: https://tech.pepabo.com/2026/02/19/tech-division-agent-ready-2026/
...
出典: https://note.com/uki_profit/n/na31ed1225e20
...
出典: https://zenn.dev/helloworld/articles/5c69b2981d5199
...
## 223_creators_bengo4_com

**問い合わせ対応の全工程の自動化を AI で実現 - CRE による MCP から Agent Skills 移行の記録**

出典: https://creators.bengo4.com/entry/2026/02/18/080000
...
出典: https://note.com/art_reflection/n/ndb4c6795c773
...
## 225_tech_timee_co_jp

**AI活用で生産性は上がる？仕様駆動開発(SDD)の実践と課題 - Timee Product Team Blog**

出典: https://tech.timee.co.jp/entry/2026/02/19/190000
...
## 226_hirokidaichi_github_io

**なぜ、AIで生産性があがっていると錯覚してしまうのか：構造的理由と知識創造への転換**

出典: https://hirokidaichi.github.io/presentation/devsummit.html
...
出典: https://zenn.dev/hawkymisc/articles/2cace1f599cc06
...
出典: https://zenn.dev/togo_asai/articles/0b5bbd51f2a7cc
...
出典: https://huggingface.co/blog/ggml-joins-hf
...
出典: https://qiita.com/nogataka/items/e04d1f6f417eec2bab54
...
## 231_nowokay_hatenablog_com

**ブラウザがGPUメモリを使いすぎるので、サブGPUのRTX3050を使わせる**

出典: https://nowokay.hatenablog.com/entry/2026/02/21/175505
...
出典: https://boristane.com/blog/the-software-development-lifecycle-is-dead/
...
出典: https://qiita.com/emi_ndk/items/fb529b2ede94661e5287
