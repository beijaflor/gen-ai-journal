...
**Original Title**: Australia Bans Generative A.I. From Official Music Charts

オーストラリアレコード産業協会（ARIA）は、生成AIによって全面的に作成された楽曲を公式チャートから除外し、人間が実質的に制作に関与した作品のみを認める新規則を発表した。
...
**Original Title**: Anthropic’s best AI model struggles to attract users as cheaper tools thrive

FTのペイウォールにより本文取得不可。見出しのみ判明、本文要約は未生成（omit）。
...
**Original Title**: We must not grant AI agents legal personhood
