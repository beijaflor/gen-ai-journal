# Curated Annex Journal Sources - 2026-06-20
...
- [ ] 003. https://nuxt.com/blog/meet-nuxi 👍
...
- [ ] 005. https://www.kylereddoch.me/blog/apples-ai-can-now-change-your-passwords-what-could-possibly-go-wrong/
  <!-- Apple Intelligenceのパスワード自動変更機能、プロンプトインジェクション等のセキュリティ懸念とガバナンス論。Signals: supabase -->

- [ ] 006. https://zenn.dev/rintaro121/articles/generative-recommendation
  <!-- 自己回帰型「Generative Recommendation」とSemantic IDを用いた推薦システムの新パラダイム。Signals: supabase -->

- [ ] 019. https://gabrielweinberg.com/p/people-are-consuming-ai-like-they
...
- [ ] 024. https://blog.johanneslink.net/2026/06/09/the-jqwik-anti-ai-affair/
...
- [ ] 042. https://www.itmedia.co.jp/news/articles/2606/12/news113.html
  <!-- Fable 5「Claude Design」で記事URLから動画生成、品質と凄まじいトークン消費を実機検証。Signals: supabase、Fable 5実用デモ -->

- [ ] 043. https://scrapbox.io/nishio/OKF%E3%81%A8LLM_Wiki 👍
  <!-- OKFとKarpathy LLM Wikiの比較、知識グラフの「赤リンク」と知的生産における安定性vs創発の論考。Signals: supabase, upvoted -->

- [ ] 051. https://note.com/rshimada/n/n776da2f06fc8
  <!-- OpenAI×AIによるエルデシュ予想反証を起点に、数学界が直面する「黒船」と数学文化継承の論考。Signals: supabase -->

- [ ] 057. https://note.com/sumisutori/n/nd5a035ad9526
  <!-- 架空映画『超かぐや姫！』をClaude Mythosに見せた哲学的対話記録、AIの実存をめぐるSF的体験。Signals: supabase、Fable 5実用デモ -->

- [ ] 059. https://insforge.dev/
  <!-- InsForge、AIエージェントが直接操作するエージェントネイティブクラウドインフラ（DB/Auth/Storage/Vector等統合）。Signals: supabase -->

- [ ] 064. https://blog.khanacademy.org/built-in-the-open-how-pilot-districts-shaped-the-reimagined-khan-academy/
  <!-- Khan Academy刷新、AI家庭教師Khanmigoを演習に統合、教師ダッシュボード強化。Signals: supabase、教育AI -->

- [ ] 067. https://platform.claude.com/docs/en/cli-sdks-libraries/libraries/apple-foundation-models
  <!-- Apple Foundation Models用Claude統合Swiftパッケージ、ローカル/サーバー共通API。Signals: supabase -->

- [ ] 070. https://crankgpt.com/
  <!-- CrankGPT、人力発電（手回し/ペダル/ジム連動）駆動の完全ローカルAI、現代AI業界へのパロディ的アンチテーゼ。Signals: supabase -->

- [ ] 071. https://github.com/sammysltd/euromesh
  <!-- EuroMesh、欧州既存公的計算資源とDiLoCo分散学習でソブリンAIモデル構築可能性を分析。Signals: supabase -->

- [ ] 073. https://www.anthropic.com/news/claude-corps
  <!-- Anthropic「Claude Corps」、1.5億ドル投じ1,000人若手をNPO派遣、Claude活用社会課題解決フェローシップ。Signals: supabase -->

- [ ] 079. https://zenn.dev/yusukebe/articles/ccb1f953e48ee1
  <!-- Cloudflare DevAdvo、V8 Isolateの優位性とAgents SDK・Code Mode等AIエージェント時代のインフラ論。Signals: supabase -->

- [ ] 097. https://cohere.com/blog/north-mini-code
...
- [ ] 102. https://subq.ai/subq-1-1-small-technical-report
  <!-- SubQ 1.1 Small、Subquadratic Sparse Attentionで1200万トークン文脈処理を可能にする新モデル。Signals: supabase、アーキテクチャ -->

- [ ] 105. https://x.com/FGuzmanAI/status/2065832668172845209
  <!-- 80MHzで56,000トークン/秒、ゲートレベル設計の100%デジタルTransformerチップ（FPGA上）。Signals: supabase、ハードウェア深掘り -->

- [ ] 108. https://www.tno.nl/en/digital/artificial-intelligence/gpt-nl/
  <!-- オランダ独自の主権型LLM「GPT-NL」、TNO/SURF/NFI協働、欧州の法律・価値観に沿った透明性重視モデル。Signals: supabase -->

- [ ] 110. https://writings.stephenwolfram.com/2026/06/launching-version-15-of-wolfram-language-mathematica-built-in-useful-ai-lots-of-new-core-functionality/
...
- [ ] 119. https://zenn.dev/hataluck/articles/0752919b305a9f
  <!-- AI出力の認知負荷を下げるClaude Code Skill、意味と見せ方を分離しHTML図解バンドル生成。Signals: supabase -->

- [ ] 125. https://gist.github.com/k16shikano/fd287c3133457c4fd8f5601d34aa817d
  <!-- 日本語技術文書の文章規範SKILL、LLM特有の空虚な表現を明示的に禁止する執筆ガイド。Signals: supabase -->

- [ ] 129. https://ptcg-abc.pokemon.co.jp/
  <!-- ポケモンカードAIバトルチャレンジ、Kaggleで開催、シミュレーション部門/ストラテジー部門。Signals: supabase -->

- [ ] 130. https://freefable.org/
...
- [ ] 150. https://www.oreilly.com/radar/who-owns-the-code-claude-wrote/
  <!-- Claudeが書いたコードの所有権論考、著作権の人間性・雇用契約・ライセンス汚染リスク。Signals: supabase -->

- [ ] 151. https://socket.dev/blog/npm-package-uses-prompt-injection-and-token-flooding-to-disrupt-ai-malware-scanners
...
- [ ] 167. https://blog.stdlib.io/ai-and-the-invisible-newcomer-in-open-source/
  <!-- AIがプライベートに新人の疑問を解決することで、OSSコミュニティの「目に見える摩擦」が消失する構造分析。Signals: supabase -->

- [ ] 177. https://ghostinthedata.info/posts/2026/2026-06-13-human-connection-moat/
  <!-- AIが複製できない競争優位の「堀」は人間関係と信頼の蓄積、サービスとホスピタリティの区別論。Signals: supabase -->

- [ ] 181. https://takoratta.hatenablog.com/entry/2026/06/17/183422
  <!-- Stack Overflow for Agents（SOFA）、AIエージェントのエラー解決策共有プラットフォーム、人間Reputationをアンカーとする設計。Signals: supabase -->

- [ ] 189. https://zenn.dev/genshi_ai/articles/88f62861a953c1
  <!-- AI臭を消すClaude Skill「stop-ai-slop-jp」、書き手の主体性・構造正常化・特定語彙削減の5段階校正。Signals: supabase -->

- [ ] 191. https://zenn.dev/nttdata_tech/articles/2fe14c8819557c
  <!-- Databricks「Omnigent」メタハーネス検証、YAMLエージェント構成・実行ポリシー・セッション共有。Signals: supabase、T5補助 -->

- [ ] 194. https://internet.watch.impress.co.jp/docs/yajiuma/2117760.html
  <!-- 文字コードShift_JISがClaude等の読み取りを意外に阻む話題、レガシー技術が最新AIの障壁となる事例。Signals: supabase -->

- [ ] 195. https://www.keio.ac.jp/ja/about/public-relations/mita-hyoron/features/20260605-2/ 👍
  <!-- 認知科学者今井むつみ、生成AIと人間の「アブダクション推論」「記号接地」「意味の不理解」を論じる。Signals: supabase, upvoted -->

- [ ] 207. https://rand.pepabo.com/article/2026/06/15/typst/
  <!-- Typstを使ったAIエージェント時代のスライド・ポスター作成、touying・CeTZ・JSAI2026での実践。Signals: supabase -->

- [ ] 211. https://zenn.dev/trilog/articles/0d4a064ce1f50e
  <!-- Fable 5が「修正機会ゼロ」の一発書きで品質を担保するため用いた数値設計・物理拘束・オートパイロット検証の技法。Signals: supabase、Fable 5実用デモ -->

- [ ] 216. https://www.itmedia.co.jp/news/articles/2606/18/news038.html
  <!-- NTT風戸氏、AIコーディング進化の5年を「ベース→インストラクション→推論」3段階で整理、データ量から質への転換。Signals: supabase -->

- [ ] 219. https://www.happyoyster.com/home
  <!-- Happy Oyster、テキスト/音声/画像でリアルタイム無限世界を生成・操作するワールドモデル。Signals: supabase -->

- [ ] 222. https://cursor.com/origin
...
- [ ] 233. https://ailayoffs.rajnandan.com/
  <!-- AI Layoff Trap論文ベース、企業のAIコスト削減が地域経済全体の需要崩壊を招くナッシュ均衡をシミュレート。Signals: supabase -->

- [ ] 240. https://www.xodium.net/2026/06/the-ai-hate-progression.html
  <!-- AI反対派になった著者が業界による同意の無視・機能の強制・クリエイター攻撃を批判する論評。Signals: supabase -->

- [ ] 243. https://blog.modelcontextprotocol.io/posts/enterprise-managed-auth/
  <!-- MCP Enterprise-Managed Authorization（EMA）、IdP経由でゼロタッチOAuth、Anthropic/MS/Okta早期サポート。Signals: supabase -->

- [ ] 249. https://blog.cloudflare.com/temporary-accounts/
